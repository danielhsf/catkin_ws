...
public:
    ...
    void callback(const sensor_msgs::PointCloud2& input){
        ...
        pcl::PointCloud<pcl::PointXYZRGBA> cloud_a, cloud_b, cloud_c;
        ...
        pcl::io::savePCDFileASCII("filtrado.pcd", cloud_c);
...
{
    ros::init(argc, argv, "vitor_code");
    ROS_INFO("Started Vitor Code");
