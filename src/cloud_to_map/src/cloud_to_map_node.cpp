...
void loadDefaults(ros::NodeHandle& nh) {
  nh.param<std::string>("frame", param.frame, "point_cloud");
  ...
  nh.param("cell_resolution", param.cellResolution, 0.002);
}
...
int main(int argc, char** argv) {
  ...
  ros::NodeHandle nh;
  ros::Subscriber sub = nh.subscribe<PointCloud>("/pcl_filtered", 1, callback);
